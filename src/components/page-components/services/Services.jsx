const Index = () => (
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-20">
          <h2 class="mb-5 text-4xl tracking-tight font-extrabold text-gray-900 ">Custom App Pricing Guide</h2>
          <p class="mb-5 font-light text-gray-500 sm:text-xl ">Every contract we handle is looked at individually, so project prices can differ. But remember, all our tools and integrations are there in the dashboard for everyone, even if you don't have a Roseware app.</p>
      </div>
      <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          ...
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow ">
              ...
              <p class="font-light text-gray-500 sm:text-lg ">This bare minimum package will get you a basic webiste from the CMS of your choice</p>
          ...
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow  xl:p-8">
              ...
              <p class="font-light text-gray-500 sm:text-lg ">Our middle of the road apps are perfect for organizations who plan for growth</p>
              <div class="flex justify-center items-baseline my-8">
          ...
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow ">
              ...
              <p class="font-light text-gray-500 sm:text-lg">This would be any full-stack or large scale project, we can make anything. <img src="" alt="" sizes="" srcset="" /></p>
              <div class="flex justify-center items-baseline my-8">
