...
export default function RegisterForm({pipedriveOuthCode}) {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      firstName: Yup.string().label("First Name").required("Please provide a first name"),
      lastName: Yup.string().label("Last Name").required("Please provide a last name"),
    ...
    onSubmit: async (values, { setSubmitting, setErrors }) => {
      ...
      try {
        ...
        if (result.meta.requestStatus === "fulfilled") {
          ...
          setErrors({ form: result.payload.error });
        }
      } catch (error) {
        setErrors({ form: error.payload.error });
      } finally {
        setSubmitting(false);
      }
    }
  ...
  return (
    <div className="space-y-10 divide-y divide-gray-900/10 w-full flex justify-center mb-20">
      <div className="grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3">
        <div className="px-4 sm:px-0">
          ...
          <p className="mt-1 text-sm leading-6 text-gray-600 max-w-xs">
            Once you save this form, you will be redirected to your dashboard. Where you can request a new project, or subscribe for one of our tools!
          </p>
          <br />
            ...
            <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="sm:col-span-4">
                ...
                <div className="mt-2.5">
                  ...
                  />
                  {formik.touched.passwordRepeat && formik.errors.passwordRepeat && (
                    <span className="text-red-400">{formik.errors.passwordRepeat}</span>
                  )}
                </div>
              </div>
            </div>
