          ...
          <div className="flex flex-wrap items-center pb-12">
            <div className="md:w-1/2 lg:w-2/3 w-full xl:pr-20 md:pr-6">
              <div className="py-2 text-color">
                <h1
                  role="heading"
                  className="text-2xl dark  lg:text-6xl md:leading-snug tracking-tighter f-f-l font-black"
                >
                  Boost adoption of product and services
                </h1>
                <p
                  role="contentinfo"
                  className="text-lg dark lg:text-3xl lg:leading-7 md:leading-10 f-f-r py-4 md:py-8"
                >
          ...
          <div className="flex flex-wrap flex-row-reverse items-center">
            <div className="md:w-1/2 lg:w-2/3 w-full lg:pl-20 md:pl-10 sm:pl-0 pl-0">
              <div className="py-2 text-color">
                <div>
                  <h1
                    role="heading"
                    className="text-2xl dark lg:text-6xl tracking-tighter md:leading-snug f-f-l font-black"
                  >
                ...
                <p
                  role="contentinfo"
                  className="text-lg dark lg:text-3xl leading-7 md:leading-10 f-f-r py-8"
                >
                  Here at Globex we take special care of what your organization
                  needs instead of selling you a mass market tool that takes a
                  one size fits all approach. I personally review each and every
            ...
            <div className="lg:w-1/3 md:w-1/2 w-full relative h-96 flex items-end justify-center">
              ...
              <div className="relative z-10 p-4 bg-white shadow rounded mx-auto w-9/12 -mb-20">
                ...
                <button
                  className="relative focus:outline-none mt-4 py-2 pr-10 bg-indigo-700 tracking-normal text-xs pl-3 cursor-pointer hover:opacity-90 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700"
                  role="button"
                >
                  View Invoice
                  <img
