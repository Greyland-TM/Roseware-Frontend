      ...
      <div className="min-h-custom mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 flex justify-center lg:px-8 md:py-40">
        <div className="flex justify-center flex-col items-left lg:flex-shrink-0 pb-4">
          ...
          <div className="mt-10 flex items-center gap-x-6">
            <Link 
              href='/contact' 
              className="rounded-md bg-Vine-900 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-Vine-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-600"
            >
              Get In Touch
            </Link>
