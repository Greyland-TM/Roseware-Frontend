...
export default function ContactForm() {
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
          ...
          <div>
            ...
            <div className="mt-2.5">
              <input
                ...
                className={`${formik.touched.lastName && formik.errors.lastName ? 'border-red-400' : 'border-gray-300'} block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6`}
              />
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <textarea
                ...
                id="message"
                rows={4}
                className={`${formik.touched.message && formik.errors.message ? 'border-red-400' : 'border-gray-300'} block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6`}
              />
            </div>
