      ...
      <div className="bg-white px-3 py-16 sm:py-4 lg:px-1">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            These features are at the core of the platform. Our tools aim to alieviate the stress of managing a business. If there is a tool your busness needs that you do not see here, let us know, and we&apos;ll see what we can do to add it {" { link_here }"}.
          </p>
        </div>
      </div>
