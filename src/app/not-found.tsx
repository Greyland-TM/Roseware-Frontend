  ...
  return (
    <div className="h-[calc(100vh-4rem)] lg:px-24 lg:py-24 md:py-20 md:px-44 px-4 py-24 items-center flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16">
        <div className="relative">
              ...
              <button className="sm:w-full lg:w-auto my-2  rounded md py-4 px-8 text-center bg-rose-600 text-white hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-700 focus:ring-opacity-50">
